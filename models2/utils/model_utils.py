...
class Log:
    def log_train(self, log_path, log_name, args, test_accs):
        ...
        with open(log_name, 'a+') as f:
            string = "model, {}, ".format(args.model)
            string = "dataset, {}, ".format(args.dataset)
            string = "n_layer, {}, ".format(args.n_layers)
            string += "n_hidden, {}, ".format(args.n_hidden)
            string += "kernel, {}, ".format(args.kernel)
            string += "sample_rate, {}, ".format(args.sr)
            string += "lr, {:.3f}, ".format(args.lr)
