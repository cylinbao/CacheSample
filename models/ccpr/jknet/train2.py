...
from model import JKNet, ResGCN
...
def run(args, run_i, model_name):
    ...
    if args.save_model or args.best_val:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model-type", type=str, default="jk", 
            help="model type, choose from jk and res")
    ...
    if args.train:
        ...
        if args.log:
            ...
            log_name = "{}/{}_{}_{}_train_log.csv".format(log_path, args.model_type, 
    ...
    if args.prof_infer:
        ...
        if args.log:
            ...
            if not os.path.exists(log_path):
                os.makedirs(log_path)
            log_name = "{}/{}_{}_{}_infer_log.csv".format(args.model_type, log_path, 
                    args.dataset, args.kernel)
            with open(log_name, 'a+') as f:
                string = "n_layer, {}, ".format(args.n_layers + 1)
                string += "n_hidden, {}, ".format(args.n_hidden)
