...
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.3 --log 
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.4 --log 
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.5 --log 
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.6 --log 
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.7 --log 
...
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=1 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=3 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=3 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=gcn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log

python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=1 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=1 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=3 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=3 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=gcn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log

python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=1 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=1 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=3 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=gcn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
return
