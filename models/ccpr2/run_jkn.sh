...
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.4 --log 
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.5 --log 
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.6 --log 
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.7 --log 
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.8 --log 
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=0.9 --log 
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3 --prof-train --n-epochs=100 --kernel=cuSPARSE --drop-edge --sr=1.0 --log 

return

# drop edge training command

python train.py --gpu=2 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3  --train --early-stop --patience=100 --n-epochs=1500 --n-runs=100 --kernel=cuSPARSE --drop-edge --sr=0.3 --log --save-model
python train.py --gpu=2 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3  --train --early-stop --patience=100 --n-epochs=1500 --n-runs=100 --kernel=cuSPARSE --drop-edge --sr=0.5 --log --save-model
python train.py --gpu=2 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=3  --train --early-stop --patience=100 --n-epochs=1500 --n-runs=100 --kernel=cuSPARSE --drop-edge --sr=0.7 --log --save-model
return
...
python train.py --gpu=0 --dataset=cora --model=jkn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=jkn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=cora --model=jkn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=jkn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=cora --model=jkn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=cora --model=jkn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
...
python train.py --gpu=0 --dataset=citeseer --model=jkn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=jkn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=citeseer --model=jkn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=jkn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=citeseer --model=jkn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=citeseer --model=jkn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
...
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=7 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=15 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=cuSPARSE --log
python train.py --gpu=0 --dataset=pubmed --model=jkn --n-hidden=64 --n-layers=31 --prof-infer --n-runs=100 --kernel=CacheSample2_V3 --log
return
